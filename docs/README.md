...
The Kotlin Kernel for Jupyter notebooks is a powerful tool that allows you to write and run [Kotlin](https://kotlinlang.org/) 2.4.0-dev-6891 code within the
...
The latest version of the Kotlin Kernel for notebooks uses the Kotlin compiler of version 2.4.0-dev-6891.
